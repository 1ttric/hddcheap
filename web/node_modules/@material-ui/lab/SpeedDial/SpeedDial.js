...
var SpeedDial = React.forwardRef(function SpeedDial(props, ref) {
  ...
  return React.createElement("div", (0, _extends2.default)({
  ...
  }, other), React.createElement(TransitionComponent, (0, _extends2.default)({
    in: !hidden,
    timeout: transitionDuration,
    unmountOnExit: true
  }, TransitionProps), React.createElement(_Fab.default, (0, _extends2.default)({
    color: "primary",
    ...
    ref: handleFabRef
  }), React.isValidElement(icon) && (0, _utils.isMuiElement)(icon, ['SpeedDialIcon']) ? React.cloneElement(icon, {
    open: open
