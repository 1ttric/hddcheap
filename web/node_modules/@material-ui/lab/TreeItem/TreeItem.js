  ...
  return {
    ...
    root: {
      ...
      '&$selected > $content $label': {
        backgroundColor: (0, _styles.fade)(theme.palette.primary.main, theme.palette.action.selectedOpacity)
      },
...
var TreeItem = React.forwardRef(function TreeItem(props, ref) {
  var children = props.children,
      ...
      other = (0, _objectWithoutProperties2.default)(props, ["children", "classes", "className", "collapseIcon", "endIcon", "expandIcon", "icon", "label", "nodeId", "onClick", "onFocus", "onKeyDown", "onMouseDown", "TransitionComponent", "TransitionProps"]);
  ...
  }, icon), React.createElement(_Typography.default, {
    component: "div",
    className: classes.label
  }, label)), children && React.createElement(TransitionComponent, (0, _extends2.default)({
    unmountOnExit: true,
